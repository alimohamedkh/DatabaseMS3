...
{
    public partial class GetExtra_plan_amount : System.Web.UI.Page
    {
        ...
        {
            decimal result = DatabaseHelper.GetRemainingOrExtra(mobno, planName, "Extra_plan_amount");
            TextBoxExtraAmount.Text = result.ToString();
        }
