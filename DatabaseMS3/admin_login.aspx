<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin_login.aspx.cs" Inherits="DatabaseMS3.admin_login" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="form-group">
            ...
            <asp:TextBox ID="usernameTB" required="required" runat="server"></asp:TextBox>
        </div>
        ...
        <asp:Button ID="admin_loginB" runat="server" OnClick="admin_loginB_Click" Text="Login" />
    </form>
</body>
</html>
